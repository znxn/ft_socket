...
async def signal_producer(config):
    ...
    while True:
        try:
            ...
            while True:
                try:        
                    async with websockets.connect(url) as websocket: #ping_interval=None
                        rcp_request = {
                            "type": "subscribe",
                                    ...
                                    if rcp_type == "entry" or rcp_type == "entry_fill":
                                        ...
                                        while retry_limit > 0:
                                            try:
                                                ...
                                                if "Insufficient assets" in str(e):
                                                    logger.error(
                                                    ...
                                                    logger.info(f'Reducing amount to {amount} due to "Insufficient assets"')
...
# Define the url_configs dictionary
conf1 = {
    "api_server": {
        "listen_ip_address": "",
        "listen_port": 9876,
